    ...
    <!--Begin Content -->
          ...
          <div class="">
            ...
            <div class="row">
                <div class="x_panel">
                @foreach($sps as $item) 
                  <form class="form-horizontal form-label-left input_mask" name="form_sua_sp" enctype="multipart/form-data" ng-app="myApp" 
                  ...
                  @endif
                    <div class="col-md-8 col-sm-8 col-xs-12" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name ="txt_tensp" placeholder="Default Input" value="{!!  $item->TenSP !!}" readonly>
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          <textarea id="txt_mota" name="txt_mota" rows="7" required="required" class="form-control ckeditor col-md-7 col-xs-12" readonly placeholder="Thêm mô tả vào đây">{{ $item->MoTa }}</textarea>                      
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="txt_gianhap" readonly id ="txt_gianhap" required="required" class="form-control col-md-7 col-xs-12" value="{{ (float)$item->GiaNhap }}" oninput="Process_Cost()" />                          
                        </div>
                      </div>
                    ...
                    <!--- Khuyến mãi tối đa 30% -->
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="txt_phantramKM" id ="txt_phantramKM" required="required" class="form-control col-md-7 col-xs-12" readonly value="{{ (float)$item->PhanTramKM }}" oninput="Process_Cost()"/>                          
                        </div>
                      </div>
                    ...
                    <br/><br/>
                      <div class="form-group">
                        <div class="col-md-7 col-sm-7 col-xs-12 col-md-offset-5">
                          <a href="{{ URL::Route('getSPList') }}"><button type="button" class="btn btn-primary">Trở về</button></a>
