            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <p style="font-size:16px">{{ session('thongbao')}}</p>
                        
                    </div>
                 </div>

                    <div class="col-md-4 col-sm-4 col-xs-12">
                    <a href="{{ URL::Route('get_chi_tiet_phieu_nhap',['id'=>$idPN]) }}" class="btn btn-info btn-lg">Quay về</a>
                    </div>
                </div>
                  @endif
                    <form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ URL::Route('post_them_phieu_nhap_exist',['id'=>$idPN]) }}" enctype="multipart/form-data" ng-app="">
                        {{ csrf_field() }}
