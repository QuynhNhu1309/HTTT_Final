...
@section('title','Báo cáo chi phí nhập hàng')
...
<div class="row">
            ...
            <form action="{{ URL::Route('baocao_chiphinhap')}}" method="GET" name="form_ad_search_nv">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" name="datatable">
                      <thead>
                        <tr>
                          ...
                          <th><center>Chi phí nhập hàng</center></th>  
                        </tr>
                      </thead>

                      <tbody>
                      <?php $stt = 0; ?>
                      @foreach($baocao_chiphinhap_thang as $key=>$value)
                      <tr>
          ...
          <?php } ?>
            ...
            function getArray_chiphinhap()
            {
              var obj_chiphinhap = <?php echo json_encode($baocao_chiphinhap_thang); ?>;
              //alert(obj_khohang);
              console.log(obj_chiphinhap);
              return obj_chiphinhap;
